...
public class Store {
    // books indexed by their names
    public static final ArrayList<Book> books = new ArrayList<>();
    private static final String filePath = "./store.dat";
    ...
    private static void init() {
        ...
        Runtime.getRuntime().addShutdownHook(new Thread(() -> {
            try (var file = new FileOutputStream(filePath)) {
                file.write(new Store().toString().getBytes());
            } catch (IOException e) {
     ...
     * @return true if the book didn't exist before and was added, false otherwise
     */
    public static boolean addBook(String isbn, String title, String category) {
     ...
     * @return true if the book didn't exist before and was added, false otherwise
     */
    public static boolean addBook(String isbn, String title) {
     ...
     */
    public static ArrayList<Book> searchAllBooksByTitle(String title) {
     ...
     */
    public static boolean deleteAllBooks(Book book) {
        var res = false;
        var allBookIndicesBySameTitle = searchAllBookIndicesByTitle(book.getTitle());
        if (allBookIndicesBySameTitle == null) return false;
        for (int idx : allBookIndicesBySameTitle) {
...
//     */
//    public static boolean deleteAllBooksByTitle(String title) {
//        var res = false;
//        var bookIndices = searchAllBookIndicesByTitle(title);
...
//    }
     ...
     */
    private static int searchBookIdxByTitle(String title) {
     ...
     */
    private static ArrayList<Integer> searchAllBookIndicesByTitle(String title) {
